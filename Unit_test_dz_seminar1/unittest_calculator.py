...
class TestCalculator(unittest.TestCase):
    ...
    def test_discount_less_0(self):
        self.assertRaisesRegex(ArithmeticError, "Размер скидки не может быть отрицательным",
                               calculate_discount, purchase_amount=100, discount_amount=-3)

    def test_discount_more_100(self):
        self.assertRaisesRegex(ArithmeticError, "Скидка не может быть больше 100%",
                               calculate_discount, purchase_amount=100, discount_amount=123)
